        ...
        public IQueryable<UserModel> Query()
        {
            ...
            var query = from user in userQuery
                        ...
                        select new UserModel()
                        {
                            ...
                            Collectives = user.CollectiveUsers.Select(c => new CollectiveModel()
                            {
                                Id = c.Collective.Id,
                                Guid = c.Collective.Guid,
                                Name = c.Collective.Name,
                                CreatedBy = c.Collective.CreatedBy,
                                CreatedDate = c.Collective.CreatedDate
                            }).ToList()
                        };
            return query;
        }
